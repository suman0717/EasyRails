...
import 'awrcreated.dart';
import 'awrsubmitted.dart';
import 'awrunsynced.dart';

class WeldReturnTab extends StatelessWidget {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar( centerTitle: true,
          bottom: TabBar(
            tabs: [
              Tab(child: Text('Submitted',style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 1.9 * SizeConfig.heightMultiplier,
                color: const Color(0xffffffff),
                fontWeight: FontWeight.w500,
              ),),),
              Tab(child: Text('Synced',style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 1.9 * SizeConfig.heightMultiplier,
                color: const Color(0xffffffff),
                fontWeight: FontWeight.w500,
              ),),),
              Tab(child: Text('Unsynced',style: TextStyle(
                fontFamily: 'Poppins',
                fontSize: 1.9 * SizeConfig.heightMultiplier,
                color: const Color(0xffffffff),
                fontWeight: FontWeight.w500,
          ...
          title: Text('Weld Return',style: TextStyle(
            fontFamily: 'Poppins',
            fontSize: 1.9 * SizeConfig.heightMultiplier,
            color: const Color(0xffffffff),
            fontWeight: FontWeight.w500,
