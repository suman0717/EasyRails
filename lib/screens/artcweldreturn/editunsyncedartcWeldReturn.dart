...
class EditUnsyncedARTCWeldReturn extends StatefulWidget {

  String weldJson;
  EditUnsyncedARTCWeldReturn({this.weldJson});
  @override
  _EditUnsyncedARTCWeldReturnState createState() => _EditUnsyncedARTCWeldReturnState();
}

class _EditUnsyncedARTCWeldReturnState extends State<EditUnsyncedARTCWeldReturn> {
  ...
  void initState() {
    ...
    _weldLocationDate = jsonDecode(widget.weldJson)["tempweldLocationDate"] != null?DateFormat("dd/MM/yyyy").parse(jsonDecode(widget.weldJson)["tempweldLocationDate"]):DateTime.now();
    _railFlawDate = jsonDecode(widget.weldJson)["temprailFlawDate"] != null?DateFormat("dd/MM/yyyy").parse(jsonDecode(widget.weldJson)["temprailFlawDate"]):DateTime.now();
    ctrlweldLocationCode.text = _weldLocationCode = jsonDecode(widget.weldJson)["tempweldLocationCode"];
    ctrlweldLocationTrack.text = _weldLocationTrack = jsonDecode(widget.weldJson)["tempweldLocationTrack"];
    ctrlkilometer.text = _kilometer = jsonDecode(widget.weldJson)["tempkilometer"];
    ctrlRail.text = _rail = jsonDecode(widget.weldJson)["temprail"];
    _railSize = jsonDecode(widget.weldJson)["temprailSize"];
    _weldReasonCode = jsonDecode(widget.weldJson)["tempweldReasonCode"];
    print('printing batch id');
    print(jsonDecode(widget.weldJson)["tempaRTCLocalBatch"]);
    ctrlaRTCLocalBatch.text = _aRTCLocalBatch = jsonDecode(widget.weldJson)["tempaRTCLocalBatch"];
    _weldType = jsonDecode(widget.weldJson)["tempweldType"];
    _siteConditionWeather = jsonDecode(widget.weldJson)["tempsiteConditionWeather"];
    _siteConditonWeld = jsonDecode(widget.weldJson)["tempsiteConditonWeld"];
    _siteConditonTrack = jsonDecode(widget.weldJson)["tempsiteConditonTrack"];
    ctrlrailTempFinal.text = _railTempFinal = jsonDecode(widget.weldJson)["temprailTempFinal"];
    _railTempNA = jsonDecode(widget.weldJson)["temprailTempFinal"]==null || jsonDecode(widget.weldJson)["temprailTempFinal"]=='N/A'?true:false;
    _railTempEnter = jsonDecode(widget.weldJson)["temprailTempFinal"] != null && jsonDecode(widget.weldJson)["temprailTempFinal"] !='N/A'?true:false;
    ctrlPunchMarkBeforeFinal.text = _punchmarkBeforeFinal = jsonDecode(widget.weldJson)["temppunchmarkBeforeFinal"];
    _punchmarkBeforeNA = jsonDecode(widget.weldJson)["temppunchmarkBeforeFinal"]==null|| jsonDecode(widget.weldJson)["temppunchmarkBeforeFinal"]=='N/A'?true:false;
    _punchmarkBeforeEnter = jsonDecode(widget.weldJson)["temppunchmarkBeforeFinal"] != null && jsonDecode(widget.weldJson)["temppunchmarkBeforeFinal"] !='N/A'?true:false;
    ctrlPunchMarkAfterFinal.text = _punchmarkAfterFinal = jsonDecode(widget.weldJson)["temppunchmarkAfterFinal"];
    _punchmarkAftereNA = jsonDecode(widget.weldJson)["temppunchmarkAfterFinal"]==null || jsonDecode(widget.weldJson)["temppunchmarkAfterFinal"]=='N/A'?true:false;
    _punchmarkAfterEnter = jsonDecode(widget.weldJson)["temppunchmarkAfterFinal"] != null && jsonDecode(widget.weldJson)["temppunchmarkAfterFinal"]!='N/A'?true:false;
    ctrlkmFrom.text = _kmFrom = jsonDecode(widget.weldJson)["tempkmFrom"];
    ctrlkmTo.text = _kmTo = jsonDecode(widget.weldJson)["tempkmTo"];
    ctrlrailTempFinal1.text = _railTempFinal1 = jsonDecode(widget.weldJson)["temprailTempFinal1"];
    _railTempNA1 = jsonDecode(widget.weldJson)["temprailTempFinal1"]==null || jsonDecode(widget.weldJson)["temprailTempFinal1"]=='N/A'?true:false;
    _railTempEnter1 = jsonDecode(widget.weldJson)["temprailTempFinal1"] != null && jsonDecode(widget.weldJson)["temprailTempFinal1"] !='N/A'?true:false;
    _ok  = jsonDecode(widget.weldJson)["tempokFinal"] == 'Yes'?true:false;
    _okFinal = jsonDecode(widget.weldJson)["tempokFinal"];
    _punchMarckCheck = jsonDecode(widget.weldJson)["temppunchMarckCheckFinal"] == 'Yes'?true:false;
    _punchMarckCheckFinal = jsonDecode(widget.weldJson)["temppunchMarckCheckFinal"];
    _RailFlawCompleted = jsonDecode(widget.weldJson)["tempRailFlawCompletedFinal"] == 'Yes'?true:false;
    _RailFlawCompletedFinal = jsonDecode(widget.weldJson)["tempRailFlawCompletedFinal"];
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ListTile(trailing: IconButton(icon: Icon(Icons.date_range_outlined), onPressed: (){pickWeldLocationDate();}),
                              title: Center(child: Text('${_weldLocationDate.day}-${_weldLocationDate.month}-${_weldLocationDate.year}')),
...
controller: ctrlRail,
                                validator: (String value){
                                  ...
                                  else if((value !='U' && value != 'D' && value !='u' && value != 'd') && value.isNotEmpty){
                          ...
                          DropDownField(onValueChanged: (dynamic value) async {
                            _railSize = value;
                          },keyboardType: TextInputType.number,
                          ...
                          Container(
                            child: TextFormField(controller: ctrlaRTCLocalBatch,
                                validator: (String value){
                                  if(value.isEmpty){
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Checkbox(value: _punchmarkBeforeEnter,
                                    ...
                                    Checkbox(value: _punchmarkBeforeNA,
                                        activeColor: kShadeColor1,
                                        onChanged: (bool newvalue){
                                          setState(() {
                                            print(newvalue);
                                            ctrlPunchMarkBeforeFinal.text='N/A';
                                ...
                                Visibility(visible: _punchmarkBeforeEnter,
                                  child: Container(
                                    child: TextFormField(
                                        validator: (String value){
                                          if(((value.isEmpty || value.contains('N/A')) && _punchmarkBeforeEnter==true)){
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Checkbox(value: _punchmarkAfterEnter,
                                        activeColor: kShadeColor1,
                                        onChanged: (bool newvalue){
                                          setState(() {
                                            print(newvalue);
                                    ...
                                    Text('Enter Punch Mark'),
                                    Checkbox(value: _punchmarkAftereNA,
                                        activeColor: kShadeColor1,
                                        onChanged: (bool newvalue){
                                          setState(() {
                                            print(newvalue);
                                            ctrlPunchMarkAfterFinal.text='N/A';
                                ...
                                Visibility(visible: _punchmarkAfterEnter,
                                  child: Container(
                                    child: TextFormField(
                                        validator: (String value){
                                          if(((value.isEmpty || value.contains('N/A')) && _punchmarkAfterEnter==true)){
                                            return 'Provide Punch Marks';
                                          }
                                        },
                                        maxLength: 5,
                            ...
                            child: Column(
                              children: [
                                ...
                                Visibility(visible: _railTempEnter,
                                  child: Container(
                                    child: DropDownField(onValueChanged: (dynamic s) async {
                                      _railTempFinal = s;
                                    },keyboardType: TextInputType.number,
                                      textStyle: TextStyle(height: 0.9,
                                          fontFamily: 'Poppins', fontSize: 1.84 * SizeConfig.heightMultiplier),
                          ...
                          Container(
                            child: TextFormField(controller: ctrlkmFrom,
                                keyboardType: TextInputType.number,
                                textAlign: TextAlign.center,
                                onChanged: (value) {
                                  _kmFrom = value;
                          ...
                          Container(
                            child: TextFormField(controller: ctrlkmTo,
                                keyboardType: TextInputType.number,
                                textAlign: TextAlign.center,
                                onChanged: (value) {
                                  _kmTo = value;
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Checkbox(value: _railTempEnter1,
                                        activeColor: kShadeColor1,
                                        onChanged: (bool newvalue){
                                          setState(() {
                                            print(newvalue);
                                ...
                                Visibility(visible: _railTempEnter1,
                                  child: Container(
                                    child: DropDownField(onValueChanged: (dynamic s) async {
                                      _railTempFinal1 = s;
                                    },keyboardType: TextInputType.number,
                          ...
                          Container(
                            ...
                            child: ListTile(trailing: IconButton(icon: Icon(Icons.date_range_outlined), onPressed: (){pickRailFlawDate();}),
                              title: Center(child: Text('${_railFlawDate.day}-${_railFlawDate.month}-${_railFlawDate.year}')),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Checkbox(value: _RailFlawCompleted,
                                        activeColor: kShadeColor1,
                                        onChanged: (bool newvalue){
                                          setState(() {
                                            if(newvalue == true){
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Checkbox(value: _punchMarckCheck,
                                        activeColor: kShadeColor1,
                                        onChanged: (bool newvalue){
                                          setState(() {
                                            if(newvalue == true){
                                  ...
                                  if(_isWeldReurnvalid==true){
                                    ...
                                    if(connectionValilable != true){
                                      ...
                                      UpdateARTCWeldReturnUnsynced updateARTCWeldReturnUnsynced = UpdateARTCWeldReturnUnsynced(
                                        ...
                                        id: _weldReturnIDfromSharedPreference,
                                        tempaRTCLocalBatch: _aRTCLocalBatch,
                                        apiURL: _apiURL,
                                      );
                                      print(_weldReturnIDfromSharedPreference);
                                      var tempJson = jsonEncode(updateARTCWeldReturnUnsynced.tojson());
                                      print(tempJson);
                                      var _artcid = jsonDecode(tempJson)['tempaRTCLocalBatch'];
                                      print(_artcid);
                                      ...
                                      unSyncArtcWeldReturn.forEach((element) {
                                        print(unSyncArtcWeldReturn.indexOf(element));
                                        if(jsonDecode(element)['id']==_weldReturnIDfromSharedPreference){
                                          _recordExists = true;
                                          print('old Record');
                                          _replaceAt = unSyncArtcWeldReturn.indexOf(element);
                                          print(_replaceAt);
                                        }
                                      }
                                      );
                                      ...
                                      if(_recordExists == false){
                                        ...
                                        unSyncArtcWeldReturn.removeAt(_replaceAt);
                                        unSyncArtcWeldReturn.add(tempJson);

                                      }
                                      print('New');
                                      print(unSyncArtcWeldReturn.length);
                                      sharedPreferences.setStringList('unSyncArtcWeldReturn', unSyncArtcWeldReturn);
