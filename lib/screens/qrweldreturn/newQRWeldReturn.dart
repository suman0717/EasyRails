...
List<String> unSyncQRWeldReturn=[];
...
var _formQRKeyWeldReturn = GlobalKey<FormState>();

class NewQRWeldReturn extends StatefulWidget {
  @override
  _NewQRWeldReturnState createState() => _NewQRWeldReturnState();
}

class _NewQRWeldReturnState extends State<NewQRWeldReturn> {
  @override
  void initState() {
    setState(() {
      _waiting = true;
    ...
    _weldKitDetailsDate = DateTime.now();
    ctrlTopPeaked.text='0.0';
    ctrlSidePeaked.text='0.0';
    ctrlTopDipped.text='0.0';
    ctrlSideDipped.text='0.0';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar( centerTitle: true,
        title: Text('NEW QR WELD RETURN',style: TextStyle(
          fontFamily: 'Poppins',
                          ...
                          Container(
                            ...
                            child: RaisedButton(color: kShadeColor1,
                              onPressed: () async {
                                ...
                                if (_formQRKeyWeldReturn.currentState.validate()) {
                                  _validate();
                                  if(_isWeldReurnvalid==true){
                                    if(connectionValilable != true){
                                      ...
                                      await Flushbar(
                                        ...
                                        messageText: Text(
                                          'You have successfully create a Weld Report Offline',
                                          style: TextStyle(
                                            fontFamily: 'Poppins',
...
//  Constructor
  QRWeldReturn({this.tempweldDate,
...
//  this function will convert json into object
  QRWeldReturn.fromJson(Map<String,dynamic> json):
